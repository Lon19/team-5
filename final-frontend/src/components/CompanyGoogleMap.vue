<template>
    <div>
        ...
        <v-row style="justify-content: space-evenly">
            ...
            <v-btn large center color="primary"
                   v-on:click="getByUnemploymentRate(unemployemntRate)">Unemployment Number
            </v-btn>
            <v-btn large center color="primary"
        ...
        <v-row style="justify-content: space-evenly">
            <v-radio-group row label="Gender:" v-model="radios" :mandatory="false" >
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            decideColour(num) {
                if (num < 50) {
                    return {fillColor: '#03bd19', fillOpacity: 0.5}
                } else if (num > 50 && num < 100) {
                    return {fillColor: '#168200', fillOpacity: 0.5}
                } else if (num > 100 && num < 150) {
                    return {fillColor: '#e8e900', fillOpacity: 0.5}
                } else if (num > 150 && num < 200) {
                    return {fillColor: '#f39433', fillOpacity: 0.5}
                } else if (num > 200 && num < 300) {
                    return {fillColor: '#a65900', fillOpacity: 0.5}
                } else {
